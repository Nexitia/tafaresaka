...
/**
 * This flow cell processes a row in a list group.
 * Its displays an icon and label in left sid and a right arrow in the right side.
 *
 * It does not uses dynamic data model, only static one.
 *
 * It is best used when you want display view directly when clicking the row.
 * The view is configured via 'RowClickHandler' subcomponent.
 *
 * @author Ramilafananana VONJISOA
 *
 */
public class StaticModelFlowCell extends MultiPresenterFactory {
