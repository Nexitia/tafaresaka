...
public class MCPersistenceConfig extends JpaBaseConfiguration {
  ...
  @Override
  @PersistenceContext(unitName = "io.github.jsoagger.starter-persistence-unit")
  @Primary
  @Bean(name = "entityManagerFactory")
  public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder) {
    return builder.dataSource(getDataSource())
        .persistenceUnit("io.github.jsoagger.starter-persistence-unit")
        .properties(getVendorProperties())
        .jta(true)
        .packages("io.github.jsoagger.core.model","io.github.jsoagger.starter.model")
        .build();
  }
